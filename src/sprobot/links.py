...
wiki_links = [
    Link(
        ...
        "https://espressoaf.com/recommendations/coffee.html",
        hints=["beans"],
    ),
    Link(
    ...
    Link(
        "extraction-theory-evenness",
        "https://espressoaf.com/info/extraction_evenness_theory.html",
    ),
    Link(
        "vario-burr-alignment",
        "https://espressoaf.com/manufacturers/baratza/alignment.html",
    ),
    Link(
        "vario-dissassembly",
        "https://espressoaf.com/manufacturers/baratza/vario_disassembly.html",
    ),
    Link(
        "vario-retention",
    ...
    Link(
        "bbe-max-shot-time",
        "https://espressoaf.com/manufacturers/breville/images/max_shot_time.html",
    ),
    Link(
        "bbe-opv-reroute",
        "https://espressoaf.com/manufacturers/breville/opv_water.html",
    ),
    Link(
        "infuser-dimmer-mod",
        "https://espressoaf.com/manufacturers/breville/dimmer.html",
    ),
    Link(
        "breville-pi-mode",
    ...
    Link(
        ...
        "https://espressoaf.com/manufacturers/la-pavoni/lever-basics.html",
    ),
    Link(
        "uniterra-nomad-info",
        "https://espressoaf.com/manufacturers/uniterra/nomad.html",
    ),
